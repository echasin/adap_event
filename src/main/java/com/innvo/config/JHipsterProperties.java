...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "adap_event@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "adap_event API";

        private String description = "adap_event API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "adap_event";
